...
from .models import (
    Direction, Track, Guide, Checklist, 
    ChecklistItem, Task, TaskOption, UserTaskAttempt
)
...
class TrackListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Track
        fields = ('id', 'name', 'short_description', 'direction', 'direction_name', 
                 'duration', 'image', 'order')
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ('id', 'title', 'description', 'task_type', 'points', 
                 'order', 'options', 'user_attempt')
